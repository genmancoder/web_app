        ...
        <div class="row">
            <div class="col-md-6">
                <form class="d-flex" method="post" action="search.php">
                    <input class="form-control me-2" type="text" name="query" placeholder="Enter your search">
                    <button class="btn btn-primary" type="submit" href="search.php">Search</button>
                </form>
            </div>
